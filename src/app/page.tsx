    ...
    <main className="min-h-screen noise-overlay">
      ...
      <section ref={heroRef} className="relative pt-32 pb-20 px-6 grid-bg">
        ...
        >
          ...
          {/* Hero code proof — moved BELOW the primary CTA so the email-gate
              conversion action sits above the fold (the dominant high-converting
              devtool hero pattern: headline → subhead → CTA → supporting visual).
              This is SDK usage, NOT the install command, so it stays
...
await desktop
  ...
  .click();`}</code>
            ...
            {/* Quantified differentiator for the 2026 computer-use buyer: the
                ...
                on latency, token cost, and reliability. Palette stays
                black / white / accent. */}
